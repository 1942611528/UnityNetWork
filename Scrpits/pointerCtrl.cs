...
public class pointerCtrl : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      // GetComponent<Renderer>().material.mainTextureOffset += new Vector2(Time.deltaTime * aniDir * scrollSpeed, 0);
        //设置纹理偏移量
      // GetComponent<Renderer>().material.SetTextureOffset("Red", new Vector2(-Time.time * aniDir * scrollSpeed, 0.0f));
       ...
       // aniFactor = Mathf.Max(minWidth, aniFactor) * maxWidth;
        ...
        if (hitInfo.transform)
        {
            ...
            shootStart.transform.LookAt(hitInfo.point);//看向目标
            ...
            // GetComponent<Renderer>().material.SetTextureScale("Red", new Vector2(0.1f * hitInfo.distance * noiseSize, noiseSize));
        ...
        {    //光线没有碰撞到物体
            ...
            GetComponent<Renderer>().material.SetTextureScale("Red", new Vector2(0.1f * maxDist * noiseSize, noiseSize));*/
        }
    }
}